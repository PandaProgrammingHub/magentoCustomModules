 ...
 */
class Fedobe_AttributeSplash_Model_Page extends Fedobe_AttributeSplash_Model_Abstract {
    ...
    static public function getUrlSuffix() {
        return trim(Mage::getStoreConfig('attributeSplash/seo/url_suffix'));
    }
   ...
   public function isEnabled()
   {
    ...
    public function getBrandPageDetails($id,$store_id){
        $pagecollection = Mage :: getModel('attributeSplash/page')->getCollection();
