...
class Fedobe_AttributeSplash_Block_Layer_View extends Mage_Catalog_Block_Layer_View
{
	/**
    ...
    protected function _initBlocks()
    {
		...
		$this->_decimalFilterBlockName = 'Mage_Catalog_Block_Layer_Filter_Decimal';
                ...
                /*$this->_stateBlockName = 'Fedobe_AttributeSplash_Block_Catalog_Layer_State';*/
		//$this->_attributeFilterBlockName = 'Fedobe_AttributeSplash_Block_Catalog_Layer_Filter_Attribute';
		//$this->_priceFilterBlockName = 'Fedobe_AttributeSplash_Block_Catalog_Layer_Filter_Price';
