 ...
 */
class Fedobe_AttributeSplash_Block_Page_View extends Mage_Core_Block_Template {
    ...
    public function getBrandInfo($id,$store_id){
        $branddata = Mage::getModel('attributeSplash/page')->getBrandPageDetails($id,$store_id);
