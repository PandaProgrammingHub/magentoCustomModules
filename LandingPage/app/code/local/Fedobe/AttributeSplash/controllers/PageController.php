...
/**
 * @category    Fedobe
 * @package     Fedobe__AttributeSplash
 * @license     http://fishpig.co.uk/license.txt
 * @author      Ben Tideswell <help@fishpig.co.uk>
 */
class Fedobe_AttributeSplash_PageController extends Mage_Core_Controller_Front_Action {
     ...
     */
    protected function _applyCustomViewLayout(Fedobe_AttributeSplash_Model_Page $splashPage) {
     ...
     *
     * @return false|Fedobe__AttributeSplash_Model_Page
     */
