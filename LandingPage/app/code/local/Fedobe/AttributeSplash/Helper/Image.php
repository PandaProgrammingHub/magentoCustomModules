...
class Fedobe_AttributeSplash_Helper_Image extends Mage_Core_Helper_Abstract
{
	/**
	 ...
	 */
	public function init(Fedobe_AttributeSplash_Model_Page $page, $attribute = 'image')
	{
