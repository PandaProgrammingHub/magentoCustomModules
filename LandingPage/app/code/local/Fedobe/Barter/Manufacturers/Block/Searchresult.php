<?php
class Fedobe_Barter_Manufacturers_Block_Searchresult extends Fedobe_Barter_Manufacturers_Block_Advanced_Result {
    ...
    public function getAttributeData(){
        ...
        if($attr_id){
            $brandpagemodel = Mage::getModel('attributeSplash/page')->load($manufacuterdata[$manufacturers[$i]['value']]['page_id']);
