<?php
class Fedobe_Assembleproduct_Adminhtml_AssembleproductController extends Mage_Adminhtml_Controller_Action{
    
      
    
    protected function _initAction(){
        $this->loadLayout()
             ->_setActiveMenu('fedobe');
  ...
  public function editAction(){
        ...
        if($id){
            ...
            if($model->getId()){
                ...
                $model->setData($data)->setId($id);
                    ...
                    Mage::getSingleton('adminhtml/session')->addError(Mage::helper('fedobe_assembleproduct')->__('Category does not exist'));
                    $this->_redirect('*/*/');
            }
        }
     Mage::register('fedobe_assembleproduct', $model);   
    $this->_title($this->__('fedobe_assembleproduct'))->_title($this->__((Mage::registry('fedobe_assembleproduct')->getName())));
    $this->loadLayout();
    $this->getLayout()->getBlock('head')->setCanLoadExtJs(true);
    $this->_addContent($this->getLayout()->createBlock('fedobe_assembleproduct/adminhtml_customproduct_edit'));
    $this->_addLeft($this->getLayout()->createBlock('fedobe_assembleproduct/adminhtml_customproduct_edit_tabs'));
    $this->renderLayout();
   ...
   public function saveAction(){
        if($data = $this->getRequest()->getPost()){
            $event_data_array  =  $data;
            Mage::dispatchEvent('adminhtml_assembleproduct_save_after', $event_data_array);
