 ...
 */
class Fedobe_AdminGridCategoryFilter_Block_Adminhtml_Catalog_Product_Edit_Tab_Bundle_Option_Search_Grid extends Mage_Bundle_Block_Adminhtml_Catalog_Product_Edit_Tab_Bundle_Option_Search_Grid
{
    ...
    /*    $categories = Mage::getResourceModel('catalog/category_collection')
        ...
        $this->addColumnAfter('fedobe_category_list', array(
                    'header'    => Mage::helper('admingridcategoryfilter')->__('Category'),
                    'index'        => 'fedobe_category_list',
                    'sortable'    => false,
                    'width' => '250px',
                    'type'  => 'options',
