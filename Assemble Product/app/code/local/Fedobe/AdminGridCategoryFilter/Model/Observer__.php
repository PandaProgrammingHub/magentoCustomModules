...
* @copyright   Copyright (c) 2013 Fedobe(http://www.fedobe.com)
* @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
*/
class Fedobe_AdminGridCategoryFilter_Model_Observer
{
	...
	{	
		...
		if( ($block instanceof Mage_Adminhtml_Block_Catalog_Product_Grid)  ) {
			$block->addColumnAfter('fedobe_category_list', array(
