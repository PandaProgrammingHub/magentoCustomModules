...
$staticBlocks = array(
    array(
        ...
        Hide it by set value of the config [Admin panel > Configuration > Fedobe > OnstepCheckout > Content > Display top static block] to "No"
        </p></div>',
    ...
    array(
        ...
        Hide it by set value of  the config [Admin panel > Configuration > Fedobe > OnstepCheckout > Content > Display bottom static block] to "No"
