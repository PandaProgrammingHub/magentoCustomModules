...
class Fedobe_OneStepCheckout_IndexController extends Fedobe_OneStepCheckout_Controller_Action
{
    ...
    {
        return Mage::getSingleton('fedobe_onestepcheckout/type_onepage');
    }

    protected function getSession()
    {
        return Mage::getSingleton('fedobe_onestepcheckout/session');
    }
    ...
    public function indexAction()
    {
        ...
        if ($customerAddressId = $quote->getCustomerId()) {
            ...
            //clear country
            $countryCode = Mage::getStoreConfig('fedobe_onestepcheckout/general/defaultcountry');
            if ($countryCode) {
        ...
        $defaultpaymentCode = Mage::getStoreConfig('fedobe_onestepcheckout/general/defaultpayment');
    ...
    public function saveStepAction()
    {
        ...
        switch ($step) {
            case 'shipping_method':
                ...
                if (Mage::getStoreConfigFlag('fedobe_onestepcheckout/checkout_process/shipping_method_is_loading_payment')){
            ...
            case 'payment_method':
                ...
                $htmlUpdates['review_partial'] = $this->_getReviewHtml();
                $updateItems[] = 'review_partial';
                if (Mage::getStoreConfigFlag('fedobe_onestepcheckout/checkout_process/payment_is_loading_shipping_method')){
    ...
    protected function _loadLayout()
    {
        ...
        if (!$this->_isLoadedOneStepLayout) {
            $this->loadLayout('fedobe_onestepcheckout_index_index');
    ...
    protected function _saveShippingAddress($force = true)
    {
        ...
        if (Mage::getStoreConfig('fedobe_onestepcheckout/shippingaddress/useshortshippingaddress')) {
