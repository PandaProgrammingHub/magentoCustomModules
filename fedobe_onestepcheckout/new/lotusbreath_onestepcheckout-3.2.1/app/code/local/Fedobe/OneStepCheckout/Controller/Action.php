...
<?php
class Fedobe_OneStepCheckout_Controller_Action extends Mage_Core_Controller_Front_Action {
    ...
    public function preDispatch() {
         ...
         */
        if(!Mage::getStoreConfig('fedobe_onestepcheckout/speedoptimizer/disablerssobserver')){
        ...
        if(!Mage::getStoreConfig('fedobe_onestepcheckout/speedoptimizer/disablevisitorlog')){
