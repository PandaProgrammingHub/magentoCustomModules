...
class Fedobe_Landingpage_Helper_Image extends Mage_Core_Helper_Abstract
{
	/**
	 ...
	 * @var const string
	 */
	const IMAGE_FOLDER = 'landingpage';
	 ...
	 *
	 * @param Fedobe_Landingpage_Model_Page $page
	 * @param string $attribute
	 * @return Fedobe_Landingpage_Helper_Image
	 */
	public function init(Fedobe_Landingpage_Model_Page $page, $attribute = 'image')
	{
