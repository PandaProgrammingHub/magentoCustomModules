...
class Fedobe_Landingpage_Model_Rule_Condition_Combine extends Mage_CatalogRule_Model_Rule_Condition_Combine {
    ...
    protected function getAllCustom() {
        $customconditions = Mage::helper('landingpage')->getAllCustomArr();
    ...
    protected function getAllCustomFilters() {
        $customfilters = Mage::helper('landingpage')->getAllCustomFiltersArr();
