               ...
               else if( $disable[$i] == 'Top_Rated')
               {
                   ...
                   $flag6=false;
                         ...
                         if($flag1)
                            ...
                            if($flag3)
                            {
                               $arr3=array('discount_percentage' => Mage::helper('catalog')->__('Discount'));
                            }
                            if($flag4)
                            {
                               $arr4=array('best_sells' => Mage::helper('catalog')->__('Best Sells'));
                            }
                            if($flag5)
                            {
            ...
            else
            {
                 return array_merge(
                    parent::getAttributeUsedForSortByArray(),
                         ...
                         array('discount_percentage' => Mage::helper('catalog')->__('Discount')),
                         array('best_sells' => Mage::helper('catalog')->__('Best Sells')),
