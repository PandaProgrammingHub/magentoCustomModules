...
class Fedobe_Avatar_GlobalSetting_Block_Adminhtml_System_Config_Form_Field_Color extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
     * Add color picker
     *
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$jsPath = $this->getJsUrl('carousel/jquery-for-admin.min.js');
		$mcPath = $this->getJsUrl('carousel/mcolorpicker/');
