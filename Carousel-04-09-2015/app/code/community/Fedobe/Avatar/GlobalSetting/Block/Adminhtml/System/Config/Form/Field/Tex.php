...
class Fedobe_Avatar_GlobalSetting_Block_Adminhtml_System_Config_Form_Field_Tex extends Mage_Adminhtml_Block_System_Config_Form_Field
{
	/**
	 * Add texture preview
	 *
	...
	protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
	{
		...
		$jsUrl = $this->getJsUrl('carousel/jquery-for-admin.min.js');
