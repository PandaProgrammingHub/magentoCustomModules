<?php
class Fedobe_Assembleproduct_IndexController extends Mage_Core_Controller_Front_Action {        
...
<?php
	...
	<td class="value">
	<select name="<?php echo $option_ids[$i];?>[]" id="<?php echo $option_labels[$i];?>" class="select multiselect validate-select" title="" multiple >
            <option value=""></option>
